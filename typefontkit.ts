...
export interface Font {
    ...
    /** the size of the font窶冱 internal coordinate grid */
    unitsPerEm: number;
    /** the font窶冱 ascender */
    ascent: number;
    /** the font窶冱 descender */
    descent: number;
    ...
    xHeight: number;
    /** the font窶冱 bounding box, i.e. the box that encloses all glyphs in the font */
    bbox: BBOX;
...
export interface Glyph {
    ...
    /** the glyph窶冱 bounding box, i.e. the rectangle that encloses the glyph outline as tightly as possible. */
    bbox: BBOX;

    /**
     * The glyph窶冱 control box.
